/* ============================================================
  ...
  function injectBriefingBoardScreens(){
      ...
      detailOv.innerHTML=
         '<div class="bb-overlay-card">'
          ...
          +'<div class="bbw">'
            ...
            +'<div class="bb-field bb-addition" id="bb-d-add-links-wrap"><label class="bb-addition-label"><input type="checkbox" id="bb-d-add-links"><span class="bb-addition-eyebrow">Links</span></label><div class="bb-addition-body" id="bb-d-links-body" style="display:none"><div class="bb-link-row"><input id="bb-d-link-url" type="text" placeholder="Paste a link, or attach a file \u2192"><button class="bb-icon-btn" id="bb-d-link-attach" type="button" title="Attach a PDF from this device">\ud83d\udcce</button><input id="bb-d-link-file" type="file" accept="application/pdf" style="display:none"><button class="bb-icon-btn" id="bb-d-link-clear" type="button" title="Remove">\u2715</button></div><div id="bb-d-link-preview" class="bb-link-preview" style="display:none"></div></div></div>'
    ...
    // instant _bbInitBoardsAndData's real per-Type load hasn't finished
    // yet, e.g. right after opening this screen fresh). _bbSwitchToBoard
    // repaints with the real color once that load and the active board
    // are both known.
